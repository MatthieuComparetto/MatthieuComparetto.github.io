...
Comme on peut voir Kmoyenne, échoue complétement complétement en séparant les spirales en leur milieu.*
On utilise alors specc et comme on peut voir sur l'image, arrive à séparer les spirales.
```{r, eval=TRUE}
require(kernlab)
data(spirals)
par(mfrow=c(1,2))
